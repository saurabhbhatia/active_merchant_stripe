...
== Sample Usage in Rails Application

In environments/development.rb
 
config.after_initialize do
  ActiveMerchant::Billing::Base.mode = :test
  ::GATEWAY = ActiveMerchant::Billing::StripeGateway.new('Stripe API Key')
end
...
charge = GATEWAY.execute(:amount => 500, :currency => 'usd',
                           :card => credit_card, :mnemonic => 'new')
